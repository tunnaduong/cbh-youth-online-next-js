...
export const metadata = {
  title: "Giới thiệu - CBH Youth Online",
  description:
    "Tìm hiểu về diễn đàn học sinh Chuyên Biên Hòa - không gian trực tuyến kết nối, chia sẻ và hỗ trợ cộng đồng học sinh.",
  keywords: "giới thiệu, CBH Youth Online, diễn đàn học sinh, Chuyên Biên Hòa",
};

export default function AboutPage() {
  return (
    <HelpCenterLayout title="Giới thiệu">
      <LeftSidebar />
